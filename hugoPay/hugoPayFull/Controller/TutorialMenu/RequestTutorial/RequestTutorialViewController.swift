//
//  RequestTutorialViewController.swift
//  Hugo
//
...
class RequestTutorialViewController: UIViewController {
    ...
    @IBAction func continueTutorial(_ sender: Any) {
        if let vc = R.storyboard.tutorialMenu.controlHPFullTutorialViewController() {
