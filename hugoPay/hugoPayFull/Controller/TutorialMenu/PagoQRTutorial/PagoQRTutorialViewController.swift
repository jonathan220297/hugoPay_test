//
//  PagoQRTutorialViewController.swift
//  Hugo
//
...
class PagoQRTutorialViewController: UIViewController {
    ...
    @IBAction func continueTutorial(_ sender: Any) {
        if let vc = R.storyboard.tutorialMenu.hugoCashTutorialViewController() {
