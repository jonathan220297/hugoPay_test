//
//  ControlHPFullTutorialViewController.swift
//  Hugo
//
...
class ControlHPFullTutorialViewController: UIViewController {
    ...
    @IBAction func continueTutorial(_ sender: Any) {
        if let vc = R.storyboard.tutorialMenu.recargaTutorialViewController() {
