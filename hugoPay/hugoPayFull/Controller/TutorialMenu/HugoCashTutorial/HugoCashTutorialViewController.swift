//
//  HugoCashTutorialViewController.swift
//  Hugo
//
...
class HugoCashTutorialViewController: UIViewController {
    ...
    @IBAction func continueTutorial(_ sender: Any) {
        if let vc = R.storyboard.tutorialMenu.requestTutorialViewController() {
